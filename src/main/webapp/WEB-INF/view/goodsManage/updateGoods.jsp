...
<body>
    <div style="width:50%;margin:12% auto;">
        <form method="post" action="<%=basePath%>/goods/updateGoods" class="layui-form layui-form-pane">
            <div>
                <div class="layui-form-item">
                    <label class="layui-form-label">id：</label>
                    <div style="width:20%" class="layui-input-block">
                        <input name="g_id" type="text" class="layui-input" value="${goods.id}" readonly>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">商品名称：</label>
                    <div style="width:50%;" class="layui-input-block">
                        <input name="g_name" type="text" class="layui-input" placeholder="请重新输入商品名称" value="${goods.name}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div style="width:20%;" class="layui-input-block">
                        <input name="g_price" type="text" class="layui-input" placeholder="请重新输入价格" value="${goods.price}">
                    </div>
                </div>
                <div class="layui-form-item">
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(var j=0;j<categories.length;j++){
                    ...
                    if(categories[j].id == ${goods.category.id}){
